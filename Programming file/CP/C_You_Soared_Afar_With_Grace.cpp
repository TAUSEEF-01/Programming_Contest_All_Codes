...
void solve()
{
    ...
    if (n % 2 == 1 && pos != n / 2)
    {
        int p1 = posa[a[pos]], v1 = a[pos], p2 = posa[a[n / 2]], v2 = a[n / 2], v3 = b[n / 2];
    ...
    for (int i = 0; i < n / 2 - 1; i++)
    {
        if (a[i] != b[n - i - 1])
        {
            int p1 = posa[b[i]], va1 = a[posa[b[i]]], p2 = n - i - 1, va2 = a[n - i - 1], vb1 = b[p1], vb2 = b[p2];
            vp.push_back({p1, p2});
