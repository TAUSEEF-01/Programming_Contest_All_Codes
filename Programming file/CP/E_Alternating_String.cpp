...
const double pi = 3.141592653589793238462643383269502884197;
...
void solve()
{
    ...
    else
    {
        ...
        for (int i = 0; i < 26; i++)
        {
            odd = max(odd, cnt_arr[i][1]);
            even = max(even, cnt_arr[i][0]);
        }
