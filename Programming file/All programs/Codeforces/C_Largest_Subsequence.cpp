...
vector<int> largest_subsequence_indices(string &a, int &n)
{
    vector<int> index;
    for (int i = 0; i < n; i++)
    {
...
void solve()
{
    ...
    vector<int> index = largest_subsequence_indices(a, n);
    ...
    */
    ...
    {
        swap(a[index[i]], a[index[sz - i - 1]]);
    }

    if (is_sorted(a.begin(), a.end()))
    {
        cout << sz - duplicate << endl;
    }
    else
    {
        cout << -1 << endl;
