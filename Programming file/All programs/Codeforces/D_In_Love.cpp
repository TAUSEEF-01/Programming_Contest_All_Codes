...
public:
    ...
    void solve() 
    {
        ...
        while(n--)
        {
            ...
            {
                if(lside.find(l) != lside.end()) lside.erase(lside.find(l));
                if(rside.find(r) != rside.end()) rside.erase(rside.find(r));
            }
            
            if(!lside.empty() && !rside.empty())
            {
                if(smax(lside)>smin(rside))
                cout<<"YES"<<endl;
                else
                cout<<"NO"<<endl;
            }
